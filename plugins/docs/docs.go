...
func (p *Plugin) RenderPage(ctx *gplugin.HookContext, pageType string) (string, gin.H) {
	...
	return "page_content.html", gin.H{"has_plugin_content": true, "plugin_content": sidebarAndArticle(base, ctx.SubPath, r), "title": r.Title, "meta_description": metaDescription(r)}
}
