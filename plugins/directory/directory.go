...
func (p *Plugin) RenderPage(ctx *gplugin.HookContext, pageType string) (string, gin.H) {
	...
	case validName(ctx.SubPath):
		...
		return "page_content.html", gin.H{"has_plugin_content": true, "plugin_content": html, "title": d.DisplayName, "page_title": d.DisplayName, "meta_description": d.Description}
	}
	return "", nil
}
